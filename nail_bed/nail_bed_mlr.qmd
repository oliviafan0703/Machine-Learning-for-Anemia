...
Previous work focuses on predicting Hgb concentration on three regressions of interest: the fingernail beds, the conjunctiva and the palmar creases. We aim to extend the previous research by developing a multilinear LASSO regression model, using features extracted from the nail bed images as predictors. We compared our results with previous work to examine the correlation between the featurs and the hemoglobin concentration levels. 
